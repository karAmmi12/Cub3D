...
/*   Updated: 2024/10/08 13:47:31 by apintus          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		if (i > 950 && i < 970)
// 			printf("wall_hit_x = %f | ray_hit = %f\n", wall_hit_x, ray->hit_point.x);
// 		wall_hit_x = fmod(wall_hit_x, data->cell_size);
// 		if (i > 950 && i < 970)
// 			printf("wall_hit_ = %f | ray_hit = %f\n", wall_hit_x, ray->hit_point.x);
// 		wall_hit_x /= data->cell_size;
// 		wall_hit = wall_hit_x;
// 		if (i > 950 && i < 970)
// 			printf("wall_hit = %f | ray_hit = %f\n", wall_hit, ray->hit_point.x);
// 	}
// 	else // Mur vertical (Est, Ouest)
// 	{
// 		wall_hit_x = data->player.pos.y + ray->perp_len * sin(ray->angle);
// 		if (i > 950 && i < 970)
// 			printf("wall_hit_y = %f | ray_hit = %f\n", wall_hit_x, ray->hit_point.y);
// 		wall_hit = fmod(wall_hit_x, data->cell_size);
// 		if (i > 950 && i < 970)
// 			printf("wall_hit_ = %f | ray_hit = %f\n", wall_hit, ray->hit_point.y);
// 		wall_hit = wall_hit / data->cell_size;
// 		if (i > 950 && i < 970)
// 			printf("wall_hit = %f | ray_hit = %f\n", wall_hit, ray->hit_point.y);
// 	}

// 	tex_x = (int)(wall_hit * (double)texture->width_img);
// 	if (ray->side_hit == 0 || ray->side_hit == 2)
// 		tex_x = texture->width_img - tex_x - 1;
